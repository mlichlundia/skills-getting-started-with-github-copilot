...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the school basketball team for practices and competitive games",
    ...
    "Art Workshop": {
        "description": "Explore painting, drawing, and other visual arts projects",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["harper@mergington.edu", "james@mergington.edu"]
    },
    "Drama Club": {
        "description": "Produce plays and learn acting, stage design, and performance skills",
        "schedule": "Thursdays, 4:30 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["ava@mergington.edu", "liam@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions and explore experiments in teams",
